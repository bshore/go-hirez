...
func (a *APIClient) GetPlayer(player string) ([]models.Player, error) {
	resp, err := a.makeRequest("getplayer", player, []models.Player{})
	if err != nil {
		return nil, err
	}
...
func (a *APIClient) GetPlayerIDByName(player string) ([]models.PlayerIDInfo, error) {
	resp, err := a.makeRequest("getplayeridbyname", player, []models.PlayerIDInfo{})
	if err != nil {
		return nil, err
	}
...
func (a *APIClient) GetPlayerIDByPortalUserID(portalID, portalUserID string) ([]models.PlayerIDInfo, error) {
	...
	resp, err := a.makeRequest("getplayeridbyportaluserid", path, []models.PlayerIDInfo{})
	if err != nil {
		return nil, err
	}
	var output []models.PlayerIDInfo
...
func (a *APIClient) GetPlayerIDsByGamertag(portalID, gamerTag string) ([]models.PlayerIDInfo, error) {
	...
	resp, err := a.makeRequest("getplayeridsbygamertag", path, []models.PlayerIDInfo{})
	if err != nil {
		return nil, err
	}
	var output []models.PlayerIDInfo
...
func (a *APIClient) GetFriends(player string) ([]models.Friend, error) {
	resp, err := a.makeRequest("getfriends", player, []models.Friend{})
	if err != nil {
		return nil, err
	}
...
func (a *APIClient) GetGodRanks(player string) ([]models.GodRank, error) {
	resp, err := a.makeRequest("getgodranks", player, []models.GodRank{})
	if err != nil {
		return nil, err
	}
...
func (a *APIClient) GetMatchHistory(player string) ([]models.Match, error) {
	resp, err := a.makeRequest("getmatchhistory", player, []models.Match{})
	if err != nil {
		return nil, err
	}
...
func (a *APIClient) GetPlayerStatus(player string) ([]models.PlayerStatus, error) {
	resp, err := a.makeRequest("getplayerstatus", player, []models.PlayerStatus{})
	if err != nil {
		return nil, err
	}
...
func (a *APIClient) GetPlayerAchievements(playerID string) (*models.PlayerAchievements, error) {
	...
	resp, err := a.makeRequest("getplayerachievements", playerID, &models.PlayerAchievements{})
	if err != nil {
		return nil, err
	}
...
func (a *APIClient) GetTeamDetails(clanID string) ([]models.TeamDetail, error) {
	resp, err := a.makeRequest("getteamdetails", clanID, []models.TeamDetail{})
	if err != nil {
		return nil, err
	}
...
func (a *APIClient) GetTeamPlayers(clanID string) ([]models.TeamPlayer, error) {
	resp, err := a.makeRequest("getteamplayers", clanID, []models.TeamPlayer{})
	if err != nil {
		return nil, err
	}
...
func (a *APIClient) SearchTeams(searchTeam string) ([]models.TeamDetail, error) {
	...
	resp, err := a.makeRequest("searchteams", searchTeam, []models.TeamDetail{})
	if err != nil {
		return nil, err
	}
	var output []models.TeamDetail
...
func (a *APIClient) SearchPlayers(searchPlayer string) ([]models.PlayerIDInfo, error) {
	resp, err := a.makeRequest("searchplayers", searchPlayer, []models.PlayerIDInfo{})
	if err != nil {
		return nil, err
	}
	var output []models.PlayerIDInfo
